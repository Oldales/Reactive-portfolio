        ...
        <>
            <footer className='footer mt-0 text-center' style={{ padding: '25px 0px', backgroundColor: '#1a1a1a'}}>
                ...
                <div className ='container mb-3 mt-4' >
                  ...
                  <a href="https://www.linkedin.com/in/olivier-charles-22b60a186/" className="btn tooltip-test icon" title="Linkedin"
                    target="_blank" rel="noopener noreferrer" style={{fontSize:30,color:'#a6a6a6',marginRight:10}}><i className="fab fa-linkedin"></i></a>
                  <a href="mailto: oliviercharles956@gmail.com" className="btn tooltip-test icon" title="Email" target="_blank" rel="noopener noreferrer"
